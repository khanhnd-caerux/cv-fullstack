...
**BEFORE** starting any task, list and review all rules in `.agent/rules/`:
...
**BEFORE** implementing any solution, list and review all skills in `.agent/skills/`:
...
**MANDATORY PROCESS:**
1. Read `.agent/skills/cxl-brainstorming/SKILL.md` completely
...
- **Rules**: `.agent/rules/` - Contains rule files (`.md` format)
- **Skills**: `.agent/skills/` - Contains skill directories with `SKILL.md` files

## Mandatory Rules

- **ALWAYS** List `.agent/rules/` directory before starting any task
- **ALWAYS** List `.agent/skills/` directory before starting any task
...
- [ ] Listed all rules in `.agent/rules/` directory
- [ ] Read all relevant rule files completely
- [ ] Listed all skills in `.agent/skills/` directory
