...
license: Apache-2.0
metadata:
  author: Anton Babenko - https://github.com/antonbabenko/terraform-skill
  version: 1.5.0
---
...
**How to use:** When you need detailed information on a topic, reference the appropriate guide. Agent will load it on demand to provide comprehensive guidance.
