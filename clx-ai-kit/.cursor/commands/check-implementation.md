...
Compare the current implementation with the design in docs/ai/design/ and requirements in docs/ai/requirements/. Use this for a focused alignment check during development. For a broader pre-push review (security, performance, conventions, cross-cutting concerns), use `/code-review` instead.
