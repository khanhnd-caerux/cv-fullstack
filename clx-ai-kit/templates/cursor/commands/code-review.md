...
Perform a local code review **before** pushing changes. Use this for a broad quality check covering security, performance, conventions, and cross-cutting concerns. For a focused design-alignment check (without the broader review), use `/check-implementation` instead.
