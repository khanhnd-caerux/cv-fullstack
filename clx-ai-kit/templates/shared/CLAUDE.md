...
Rules, skills, and commands are installed in the Claude Code environment directory:

- **Rules**: `.claude/rules/`
- **Skills**: `.claude/skills/`
- **Commands**: `.claude/commands/`

Claude Code automatically loads `.claude/rules/*.md`.
Read `SKILL.md` in each relevant skill directory before implementing.
